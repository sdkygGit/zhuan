...
import com.zhuanworld.dev.widget.TweetPicturesPreviewerItemTouchCallback;
...
//                    ImageGalleryActivity.show(mCallback.getContext(), model.path, false);
    ...
    public boolean onItemMove(int fromPosition, int toPosition) {
        ...
        move(mModels, fromPosition, toPosition);

        notifyItemMoved(fromPosition, toPosition);
        return true;
    }

    <T> Collection<T> move(List<T> collection, int fromPosition, int toPosition) {
