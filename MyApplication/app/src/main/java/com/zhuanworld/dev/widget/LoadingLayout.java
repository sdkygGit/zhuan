...
//        }
        ...
        imageWrapper = mInnerLayout.findViewById(R.id.image_wrapper);
        labelWrapper = mInnerLayout.findViewById(R.id.label_wrapper);
        ...
        switch (mode) {
            case PULL_FROM_END:
                ...
                ViewGroup.LayoutParams vlp = imageWrapper.getLayoutParams();
                vlp.width = ViewGroup.LayoutParams.MATCH_PARENT;
                imageWrapper.setLayoutParams(vlp);
                labelWrapper.setVisibility(GONE);
