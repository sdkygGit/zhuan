package com.zhuanworld.dev.api;
...
public class ApiHttpClient {
    ...
    public static void init(Application context) {
        ...
        // Set Cookie
        setCookieHeader(AccountHelper.instance(context).getCookie());
    }
